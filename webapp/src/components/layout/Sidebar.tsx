...
const navItems = [
  ...
  { href: "/models", label: "Model Depot", icon: Box, section: "space" },
  { href: "/textures", label: "Texture Depot", icon: ImageIcon, section: "space" },
  ...
  { href: "/backups", label: "Backups", icon: Archive, section: "meta" },
